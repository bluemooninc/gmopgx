<?php
require_once dirname(dirname(__FILE__)).'/output/EntryExecTranPayEasyOutput.php';
require_once dirname(dirname(__FILE__)).'/input/TdVerifyInput.php';
require_once dirname(dirname(__FILE__)).'/input/AcsParam.php';
require_once dirname(dirname(__FILE__)).'/tran/EntryTranPayEasy.php';
require_once dirname(dirname(__FILE__)).'/tran/ExecTranPayEasy.php';
